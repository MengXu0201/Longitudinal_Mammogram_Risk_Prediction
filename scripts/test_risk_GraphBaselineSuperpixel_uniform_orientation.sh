...
OUTPUT_DIR_PATH="/mnt/cv_data/users/mengxu/Longitudinal_Mammogram_Risk_Prediction/output_models/risk_prediction_graph_baseline_superpixel_uniform_orientation"
TEST_FOLDER_PATH="/mnt/cv_data/users/mengxu/Longitudinal_Mammogram_Risk_Prediction/output_test_results/risk_prediction_graph_baseline_superpixel_uniform_orientation"
TRAINING_ID="embed_balanced_split_graph_baseline_superpixel_uniform_orientation"
DATASET="EMBED"

...
OUTPUT_DIR_PATH="/mnt/cv_data/users/mengxu/Longitudinal_Mammogram_Risk_Prediction/output_models/risk_prediction_no_alignment_cropped" # saved model .pth
TEST_FOLDER_PATH="/mnt/cv_data/users/mengxu/Longitudinal_Mammogram_Risk_Prediction/output_test_results/risk_prediction_no_alignment_cropped" # where to save the test results (logs, predictions, and metrics)
TRAINING_ID="embed_balanced_split_no_alignment_cropped" # load the model trained with the cropped png files
